...
public partial class MainWindow : Form
{
    ...
    private void RunSelectedJobToolStripMenuItem_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageDisplayer.Tell(this, @"No job is selected.", Text);
            return;
        }
    ...
    private void MainWindow_Shown(object sender, EventArgs e)
    {
        ...
        if (!Jobs.LoadSuccess)
        {
            ...
            MessageDisplayer.Yell(this, t.ToString(), Text);
        ...
        if (Config.IsAdministrator && !string.IsNullOrWhiteSpace(Jobs.LoadFailedMessage))
            MessageDisplayer.Yell(this, Jobs.LoadFailedMessage, Text);
    ...
    private void SaveJobs()
    {
        ...
        {
            Cursor = Cursors.Default;
            MessageDisplayer.Yell(this, $@"Failed to save the file ""{Config.GetJobFilePath()}"".", Text);
        }
    }
    ...
    private void EditJobToolStripMenuItem_Click(object sender, EventArgs e)
    {
        ...
        if (grid1.SelectedJob == null)
        {
            MessageDisplayer.Tell(this, "No job is selected.", "Edit job");
            return;
        }
    ...
    private void AboutToolStripMenuItem_Click(object sender, EventArgs e) =>
        MessageDisplayer.Tell(this, VersionHistory.GetVersionHistory(), $"About JobRunner {Application.ProductVersion}");
    ...
    private void openLogToolStripMenuItem_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageDisplayer.Yell(this, exception.Message, @"Failed to open log");
        }
    }
    ...
    private void deleteVariableToolStripMenuItem_Click(object sender, EventArgs e)
    {
        ...
        if (!MessageDisplayer.Ask(this, $@"Are you sure you want to delete the variable ""{variable.Name}""?", "Delete variable"))
            return;
